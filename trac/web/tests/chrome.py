...
from trac.web.chrome import (
    Chrome, INavigationContributor, ITemplateStreamFilter, add_link, add_meta, add_notice,
    ...
    def setUpClass(cls):
        ...
        class TestTemplateStreamFilter(Component):
            ...
            def filter_stream(self, req, method, filename, stream, data):
                return stream | Transformer('//body').prepend('Bláh')
...
def test_suite():
    ...
    if genshi:
        suite.addTest(makeSuite(ChromeTemplateStreamFilterTestCase))
    else:
